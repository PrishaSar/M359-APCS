...
public class Notes_8_1 {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < arr2D.length; i++){
            for(int n = 0; n < arr2D[0].length; n++){
        ...
        */
        ...
        for(int r = 0; r < multiples.length; r++){
            int fac = r + 2;
            for(int c = 0; c < multiples[0].length; c++){
                int mul = c + 1;
                multiples[r][c] = fac * mul;
            }
        }
        ...
        for(int i = 0; i < multiples.length; i++){
            for(int n = 0; n < multiples[0].length; n++){
                System.out.print(multiples[i][n] + " ");
            }
            System.out.println();
        }
